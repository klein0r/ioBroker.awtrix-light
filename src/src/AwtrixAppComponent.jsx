...
class AwtrixAppComponent extends ConfigGeneric {
    constructor(props) {
        super(props)
        this.filterRefs = {};
    ...
    static getComparator(order, orderBy) {
        return order === 'desc'
            ? (a, b) =>  AwtrixAppComponent.descendingComparator(a, b, orderBy)
            : (a, b) => -AwtrixAppComponent.descendingComparator(a, b, orderBy);
    }
    ...
    stableSort = (order, orderBy) => {
        const { value } = this.state;
        const comparator = AwtrixAppComponent.getComparator(order, orderBy);
...
export default withStyles(styles)(AwtrixAppComponent);
